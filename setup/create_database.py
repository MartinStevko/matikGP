Plch (priezvisko)
Podhradský (priezvisko)
Podkonický (priezvisko)
Polák (priezvisko)
Polgár (priezvisko)
Poliak (priezvisko)
Pollák (priezvisko)
Prohaska (priezvisko)
Proháska (priezvisko)
Prohászka (priezvisko)
Procháska (priezvisko)
Prochazka (priezvisko)
Procházka (priezvisko)
Pucher (priezvisko)
Pupák (priezvisko)
Puskás (priezvisko)
Puška (priezvisko)
...
Sklář (priezvisko)
Sklenár (priezvisko)
Sklenárik (priezvisko)
Sklenář (priezvisko)
Sklenařík (priezvisko)
Sklenica (priezvisko)
Sklenička (priezvisko)
Sklenka (priezvisko)
Skokan (priezvisko)
Skutecký (priezvisko)
Slašťan (priezvisko)
...
Starosta (priezvisko)
Stefan (priezvisko)
Stefanovič (priezvisko)
Stevanovič (priezvisko)
Stodola (priezvisko)
Straka (priezvisko)
Strauss (priezvisko)
Strnisko (priezvisko)
...
Szalay (priezvisko)
Szekeres (priezvisko)
Szelepcsényi (priezvisko)
Szomolányi (priezvisko)
Š
Šalajka (priezvisko)
Šarkan (priezvisko)
Ševčenko (priezvisko)
...
Vicena (priezvisko)
Vico (priezvisko)
Vilikovský (priezvisko)
Višňovský (priezvisko)
Vlach (priezvisko)
Vlachovič (priezvisko)
Vlk (priezvisko)
Vlna (priezvisko)
Vlnka (priezvisko)
Vojtek (priezvisko)
...
Vomáčka (priezvisko)
Vondra (priezvisko)
Vondráček (priezvisko)
Vondrák (priezvisko)
Vondrka (priezvisko)
Vondruška (priezvisko)
Vozar (priezvisko)
Vozár (priezvisko)
Vozáry (priezvisko)
Vrabec (priezvisko)
...
Weiss (priezvisko)
Williams (priezvisko)
Wittlinger (priezvisko)
Z
Záborský (priezvisko)
Zachar (priezvisko)
Zachara (priezvisko)
Zachariaš (priezvisko)
Zachariáš (priezvisko)
Zajac (priezvisko)
Zajíc (priezvisko)
Zatopek (priezvisko)
Zátopek (priezvisko)
...
def delete(char, data):
    for ch in data:
        if data.find(char) != -1:
            i = data.find(char)
        else:
            break
        data = data[:i]+data[(i+len(char)):]
    return data

p_mena = delete(',', p_mena)
p_mena = delete('\n', p_mena)
p_mena = delete(' ', p_mena)

t_mena = delete(' ', t_mena)

t_priezviska = delete(',', t_priezviska)
t_priezviska = delete('\n', t_priezviska)
t_priezviska = delete('(priezvisko)', t_priezviska)

for letter in 'A Á Ä B C Č D Ď Dz Dž E É F G H Ch I Í J K L Ľ Ĺ M N Ň O Ó Ô P Q R Ŕ S Š T Ť U Ú V W X Y Ý Z Ž':
    if letter == ' ':
        pass
    else:
        delete((letter+' '), t_priezviska)
...
# list format
def format(input_data, output_data, char):
    for ch in input_data:
        if input_data.find(char) != -1:
            i = input_data.find(char)
        else:
            break
        if i > 0:
...
with open('setup\init_database.txt', 'w') as f:
    ...
    for i in range(40):
        ...
        meno = choice(m)
        qSila = randint(1,5)
        qRychlost = randint(1,5)
        qPostreh = randint(1,5)
        qOdolnost = randint(1,5)
        cena = round((qSila+qRychlost+qPostreh+qOdolnost)**2/5)
        f.write("Trener.objects.create(meno='%s', cena=%d, qSila=%d, qRychlost=%d, qPostreh=%d, qOdolnost=%d)\n" % (meno, cena, qSila, qRychlost, qPostreh, qOdolnost))
